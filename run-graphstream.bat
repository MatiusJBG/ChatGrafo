...
javac -cp "%CLASSPATH%" -d bin src/app/Main.java src/app/SocialNetworkApp.java src/user/User.java src/graph/SocialGraph.java src/graph/GraphTraversal.java src/analysis/SocialAnalysis.java src/community/Community.java
if %ERRORLEVEL% neq 0 (
